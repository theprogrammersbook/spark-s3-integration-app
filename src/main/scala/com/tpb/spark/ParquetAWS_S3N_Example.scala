...
object ParquetAWS_S3N_Example extends App{
    ...
    df.write
      .parquet("s3n//nagaraju-databricks-test1/parquets3n/people.parquet")


    val parqDF = spark.read.parquet("s3n://nagaraju-databricks-test1/parquets3n/people.parquet")
    ...
    df.write
      ...
      .parquet("s3n://nagaraju-databricks-test1/parquets3n/people2.parquet")
